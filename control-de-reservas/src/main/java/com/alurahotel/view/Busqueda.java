...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Busqueda.class.getResource("/com/alurahotel/img/lupa2.png")));
		...
		panel.addTab("Reservas", new ImageIcon(Busqueda.class.getResource("/com/alurahotel/img/reservado.png")),
				scroll_table, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(Busqueda.class.getResource("/com/alurahotel/img/pessoas.png")),
		...
		lblNewLabel_2.setIcon(new ImageIcon(Busqueda.class.getResource("/com/alurahotel/img/Ha-100px.png")));
