...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(RegistroHuesped.class.getResource("/com/alurahotel/img/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton()
				.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/alurahotel/img/icon-reservas.png")));
		...
		txtNreserva.setText(String.valueOf(this.huespedController.getReservaActual()));
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/alurahotel/img/registro.png")));

		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/alurahotel/img/Ha-100px.png")));
	...
	public void guardar() {
		if (txtNombre.getText().isBlank() || txtApellido.getText().isBlank() || txtFechaN.getDate().equals(null)
				|| txtNacionalidad.getSelectedItem().equals("") || txtNreserva.getText().isBlank()
		...
		java.sql.Date fechaSql = conversor.convert(txtFechaN.getDate());

		var huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), fechaSql,
				String.valueOf(txtNacionalidad.getSelectedItem()), txtTelefono.getText(),
				Integer.valueOf(txtNreserva.getText()));
		
		this.huespedController.crear(huesped, Integer.valueOf(txtNreserva.getText()));
