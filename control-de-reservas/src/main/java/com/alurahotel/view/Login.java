...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/com/alurahotel/img/img-hotel-login-.png")));
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				ingreso(txtUsuario.getText(), password);
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/com/alurahotel/img/lOGO-50PX.png")));
	...
	private void ingreso(String nombreUsuario, String password) {
		...
		var usuarioAIngresar = this.userController.validarUsuario(nombreUsuario, password);
